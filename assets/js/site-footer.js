(function () {
  ...
  style.textContent = `
    ...
    @media(max-width:420px){.cyclify-footer__inner{grid-template-columns:1fr;gap:25px}.cyclify-footer__brand{grid-column:auto}.cyclify-footer__heading{margin-bottom:13px}.cyclify-footer__links{gap:11px}}
  `;
